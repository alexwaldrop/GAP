...
class Annovar(Module):
    ...
    def define_input(self):
        ...
        self.add_argument("operations",         is_required=True, default_value="g,r,f,f,f,f,f,f,f,f,f,f,f")
        self.add_argument("protocol",           is_required=True, default_value="refGene,genomicSuperDups,exac03,gnomad_exome,snp138,esp6500_all,1000g2015aug_all,popfreq_max,cosmic70,ljb26_all,cadd13gt10,nci60,clinvar_20160302")

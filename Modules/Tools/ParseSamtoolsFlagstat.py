...
class ParseSamtoolsFlagstat(Module):
    ...
    def __init__(self, module_id):
        ...
        self.input_keys     = ["flagstat", "qc_parser", "note", "nr_cpus", "mem"]
    ...
    def define_output(self, platform, split_name=None):
        ...
        summary_file = self.generate_unique_file_name(split_name=split_name, extension=".flagstat.qc_report.json")

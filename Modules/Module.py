...
class Module(object):
    ...
    def __init__(self, module_id):
        ...
        # Specifies whether command generated by module is quick or long-running command
        # Determines whether process gets run on main processor (quick) or on newly created child processor(long)

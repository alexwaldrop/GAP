...
class Module(object):
    ...
    def __init__(self, platform):
        ...
        # List of resources available on platform
        self.resources   = self.platform.get_input_files()
        ...
        self.wrk_dir                = self.platform.wrk_dir
        self.tmp_dir                = self.platform.tmp_dir
        self.bin_dir                = self.platform.log_dir
        ...
        self.required_input_types       = None
        self.required_resource_types    = None
    ...
    def generate_output_file_path(self, output_key, **kwargs):
        ...
        if output_file_path is None:
            ...
            prefix              = self.input_data.get_pipeline_name()
    ...
    def get_required_input_types(self):
        return self.required_input_types

    def get_required_resource_types(self):
        return self.required_resource_types

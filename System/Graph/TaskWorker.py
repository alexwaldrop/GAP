...
class TaskWorker(Thread):
    ...
    def task(self):
        try:
            ...
            # Handle but do not raise any exceptions if job was externally cancelled
    ...
    def __execute(self):
        ...
        disk_space = self.__compute_disk_requirements()
        ...
        output_dir = self.proc.get_output_dir()
        cmd = self.module.get_command(output_dir)
        ...
        # Save output files
        self.platform.persist(self.proc, output_dir, self.final_output_dir)
